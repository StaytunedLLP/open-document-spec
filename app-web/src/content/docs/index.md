...
Welcome to the Open Document Spec (ODS) User Guide. Choose a topic below to get started:

- [Introduction](/docs/introduction): Core design principles, Level 0–3 adoption ladder, learning path, and benefits.
- [Quickstart Guide](/docs/quickstart): Skill-first setup, workspace initialization, service background daemon, validation, and AI context.
- [Adopting ODS](/docs/adoption): Enriching existing Markdown repositories progressively without migration overhead.
