...
const pages = [
  ...
  { url: "/spec/spec", priority: "0.9", changefreq: "weekly" },
  { url: "/spec/profiles", priority: "0.8", changefreq: "weekly" },
  { url: "/spec/graph", priority: "0.8", changefreq: "weekly" },
  { url: "/spec/context", priority: "0.8", changefreq: "weekly" },
  { url: "/spec/indexes", priority: "0.8", changefreq: "weekly" },
  { url: "/spec/resources-and-code", priority: "0.8", changefreq: "weekly" },
  { url: "/spec/validation", priority: "0.8", changefreq: "weekly" },
  { url: "/spec/non-goals", priority: "0.7", changefreq: "monthly" },
