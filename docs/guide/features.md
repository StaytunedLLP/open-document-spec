...
Frontmatter is split into **universal top-level** keys (any tool can read them) and **engine keys under `ods:`** (ODS-only). See normative [SPEC.md §3](../../src/specs/SPEC.md).
