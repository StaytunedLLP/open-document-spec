...
**Why:** native is about *where the code lives*; namespaces are about *which spec rules apply*. See [migration plan](./ods_to_odc_migration_and_cli_architecture.md) and [key comparison](../../other-specs/frontmatter-keys-ods-vs-okf.md).
...
**Authors:** purpose and ODS-vs-OKF availability → [frontmatter-keys-ods-vs-okf.md](../../other-specs/frontmatter-keys-ods-vs-okf.md).
