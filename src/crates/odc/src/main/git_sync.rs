        ...
        Ok(workspace) => {
            ...
            let root_meta = workspace
                ...
                .and_then(|doc| match &doc.frontmatter {
                    odc_core::FrontmatterState::Parsed(fm) => {
            ...
            match root_ods {
                Some(version) if version == odc_core::current_ods_spec_version() => {
            ...
            match root_ods_cli {
                Some(requirement) => match odc_core::ods_cli_requirement_satisfied(requirement) {
                    Ok(true) => {
