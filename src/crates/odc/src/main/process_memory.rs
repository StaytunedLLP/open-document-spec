fn print_path_change_report(
    ...
    from: &str,
    to: &str,
    report: &odc_core::PathChangeReport,
    format: OutputFormat,
    verb: &str,
) {
    match format {
...
fn print_aliases(workspace: &odc_core::Workspace) {
...
fn print_alias_suggestions(workspace: &odc_core::Workspace) {
...
fn print_tags(workspace: &odc_core::Workspace, include_all: bool, format: OutputFormat) {
